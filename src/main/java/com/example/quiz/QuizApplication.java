...
public class QuizApplication {
	...
	private void setup(){
		...
		//엔티티 생성
		Quiz quiz1 = new Quiz(null, "JAVA는 객체지향 언어입니다.", true, "등록 담당자");
		Quiz quiz2 = new Quiz(null, "스프링 데이터는 데이터 액세스에 관련된 기능을 제공합니다.", true, "등록 담당자");
		Quiz quiz3 = new Quiz(null, "프로그램이 많이 등록되어 있는 서버를 라이브러리라고 합니다.", false, "등록 담당자");
		Quiz quiz4 = new Quiz(null, "@Component는 인스턴스 생성 어노테이션 입니다.", true, "등록 담당자");
		Quiz quiz5 = new Quiz(null,
				"스프링 MVC에서 구현하고 있는 디자인 패턴에서 모든 요청을 하나의 컨트롤러에서 받는 것을 싱글 컨트롤러 패턴이라고 합니다.",
				false, "등록 담당자");
		// 리스트에 엔티티를 저장
	...
	private void updateQuiz(){
		...
		//변경할 엔티티를 생성
		Quiz quiz1 = new Quiz(1,"스프링은 프레임워크입니까?", true, "변경 담당자");
		// 변경 처리
